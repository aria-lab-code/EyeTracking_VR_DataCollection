...
public class GazeCollection2 : MonoBehaviour
{
    ...
    void RemoveFirstLine(string path)
    {
...
Environment.NewLine;
    ...
    private IEnumerator Sequence()
    {
        ...
        breakMessage2.text = "Welcome to the virtual environment. \n" +
                             "In this test, please  remain your body stationary while you control your movements using only your neck and eyes.\n" +
                             "Please click <Continue> to start the practice section.";
        yield return StartCoroutine(DisplayBreakMenu());
        breakMessage2.text = "Before we commence the practice session, it's essential to familiarize yourself with the button functionality.\n" +
                             "Upon selecting the button, you will notice a delightful change in its color to a soothing light blue.\n" +
                             "During this time, you may proceed to click the button using the controller located at the bottom.\n" +
                             "Now, kindly attempt to select and click the <Continue> button to initiate the practice.\n" +
                             "Should you accidentally click <Rest>, please be aware that you will be required to perform the calibration process once again.";
        yield return StartCoroutine(DisplayCalibrationMenu());
       
        
        breakMessage2.text = "The blue cube is the focused cube. The player should try to follow the cube in the Linear Pursuit section and the Arc Pursuit Section.\n"
                                + "When the player looks at the cube, it will turn green.\n" +
                                "Please press <Continue> to do the practice";
        yield return StartCoroutine(DisplayBreakMenu());
        ...
        breakMessage2.text = "In the Rapid Movement Section, the blue cubes will relocate when the player looks at it.\n" +
                            "Please press <Continue> to do the practice";
        yield return StartCoroutine(DisplayBreakMenu());
    ...
    {
        UnityEngine.Debug.Log("Enter Dispaly break menu");
        continueClicked = false;
        BreakCanvas2.enabled = true;
        BreakCanvas2.gameObject.SetActive(true);
